...
public class HttpPutTest {
    ...
    @Test
    public void canSendDataViaPut() throws Exception {
        HttpResponse response = put("http://localhost:8001/create", "key" );

        assertThat( response.getStatusCode(), equalTo( 200 ) );
        assertThat( response.getBody(), equalTo( "method=PUT data=key" ) );
    }
}
